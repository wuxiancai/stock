...
class TechnicalIndicator(Base):
    ...
    stock_code = Column(String(10), ForeignKey("stocks.stock_code"), nullable=False)
    trade_date = Column(Date, nullable=False)
    macd_dif = Column(Decimal(8, 4))
    macd_dea = Column(Decimal(8, 4))
    macd_histogram = Column(Decimal(8, 4))
    kdj_k = Column(Decimal(8, 4))
    kdj_d = Column(Decimal(8, 4))
    kdj_j = Column(Decimal(8, 4))
    rsi_6 = Column(Decimal(8, 4))
    rsi_12 = Column(Decimal(8, 4))
    rsi_24 = Column(Decimal(8, 4))
    ma_5 = Column(Decimal(10, 3))
    ma_10 = Column(Decimal(10, 3))
    ma_20 = Column(Decimal(10, 3))
    ma_60 = Column(Decimal(10, 3))
    created_at = Column(DateTime(timezone=True), server_default=func.now())
...
class DailyBasic(Base):
    ...
    close_price = Column(Decimal(10, 3))
    turnover_rate = Column(Decimal(8, 4))
    turnover_rate_f = Column(Decimal(8, 4))
    volume_ratio = Column(Decimal(8, 4))
    pe_ratio = Column(Decimal(8, 2))
    pe_ratio_ttm = Column(Decimal(8, 2))
    pb_ratio = Column(Decimal(8, 2))
    ps_ratio = Column(Decimal(8, 2))
    ps_ratio_ttm = Column(Decimal(8, 2))
    dv_ratio = Column(Decimal(8, 4))
    dv_ttm = Column(Decimal(8, 4))
    total_share = Column(Decimal(15, 2))
    float_share = Column(Decimal(15, 2))
    free_share = Column(Decimal(15, 2))
    total_mv = Column(Decimal(15, 2))
    circ_mv = Column(Decimal(15, 2))
    created_at = Column(DateTime(timezone=True), server_default=func.now())
...
class MoneyFlow(Base):
    ...
    stock_code = Column(String(10), ForeignKey("stocks.stock_code"), nullable=False)
    trade_date = Column(Date, nullable=False)
    buy_sm_vol = Column(Decimal(15, 2))
    buy_sm_amount = Column(Decimal(15, 2))
    sell_sm_vol = Column(Decimal(15, 2))
    sell_sm_amount = Column(Decimal(15, 2))
    buy_md_vol = Column(Decimal(15, 2))
    buy_md_amount = Column(Decimal(15, 2))
    sell_md_vol = Column(Decimal(15, 2))
    sell_md_amount = Column(Decimal(15, 2))
    buy_lg_vol = Column(Decimal(15, 2))
    buy_lg_amount = Column(Decimal(15, 2))
    sell_lg_vol = Column(Decimal(15, 2))
    sell_lg_amount = Column(Decimal(15, 2))
    buy_elg_vol = Column(Decimal(15, 2))
    buy_elg_amount = Column(Decimal(15, 2))
    sell_elg_vol = Column(Decimal(15, 2))
    sell_elg_amount = Column(Decimal(15, 2))
    net_mf_vol = Column(Decimal(15, 2))
    net_mf_amount = Column(Decimal(15, 2))
    created_at = Column(DateTime(timezone=True), server_default=func.now())
